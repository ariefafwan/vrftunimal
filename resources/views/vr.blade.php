...
<head>
    ...
    <link rel="preload" href="{{ asset ('3dtour/script.js?v=1666473458822" as="script') }}"/>
    <link rel="preload" href="{{ asset ('3dtour/media/panorama_D839B6A2_D332_99B3_41E8_839025BAC96E_0/l/2/0_0.jpg?v=1666473458822') }}" as="image"/>
    <link rel="preload" href="{{ asset ('3dtour/media/panorama_D839B6A2_D332_99B3_41E8_839025BAC96E_0/r/2/0_0.jpg?v=1666473458822') }}" as="image"/>
    <link rel="preload" href="{{ asset ('3dtour/media/panorama_D839B6A2_D332_99B3_41E8_839025BAC96E_0/u/2/0_0.jpg?v=1666473458822') }}" as="image"/>
    <link rel="preload" href="{{ asset ('3dtour/media/panorama_D839B6A2_D332_99B3_41E8_839025BAC96E_0/d/2/0_0.jpg?v=1666473458822') }}" as="image"/>
    <link rel="preload" href="{{ asset ('3dtour/media/panorama_D839B6A2_D332_99B3_41E8_839025BAC96E_0/f/2/0_0.jpg?v=1666473458822') }}" as="image"/>
    <link rel="preload" href="{{ asset ('3dtour/media/panorama_D839B6A2_D332_99B3_41E8_839025BAC96E_0/b/2/0_0.jpg?v=1666473458822') }}" as="image"/>
    ...
    <script src="{{ asset ('3dtour/lib/tdvplayer.js?v=1666473458822') }}"></script>
    <script type="text/javascript">
        ...
        function loadTour()
        {
            ...
            settings.set(TDV.PlayerSettings.SCRIPT_URL, '3dtour/script.js?v=1666473458822');
            settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, '3dtour/lib/WebVRPolyfill.js?v=1666473458822');
            settings.set(TDV.PlayerSettings.HLS_URL, '3dtour/lib/Hls.js?v=1666473458822');
            settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1666473458822');
...
loadTour()
    ...
    <link rel="stylesheet" href="{{ asset ('3dtour/fonts.css?v=1666473458822') }}">
</head>
<body onload="onLoad()">
    <div id="preloadContainer" style="background-color:rgba(255,255,255,1)"><div style="z-index: 4; position: absolute; left: 0%; top: 50%; width: 100.00%; height: 10.00%"><div style="text-align:left; color:#000; "><DIV STYLE="text-align:center;"><SPAN STYLE="letter-spacing:0vmin;color:#777777;font-size:1.22vmin;font-family:Arial, Helvetica, sans-serif;">Loading virtual tour. Please wait...</SPAN></DIV><p STYLE="margin:0; line-height:0.87vmin;"><BR STYLE="letter-spacing:0vmin;color:#000000;font-size:0.87vmin;font-family:Arial, Helvetica, sans-serif;"/></p></div></div></div>
    <div id="viewer"></div>
</body>
</html>