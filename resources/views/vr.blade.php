...
<head>
    ...
    <link rel="preload" href="{{ asset ('script.js?v=1666473458822') }}" as="script"/>
    ...
    <script type="text/javascript">
        ...
        function loadTour()
        {
            ...
            settings.set(TDV.PlayerSettings.SCRIPT_URL, 'script.js?v=1666473458822');
            settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, 'lib/WebVRPolyfill.js?v=1666473458822');
            settings.set(TDV.PlayerSettings.HLS_URL, 'lib/Hls.js?v=1666473458822');
...
loadTour()
    ...
    <link rel="stylesheet" href="{{ asset ('fonts.css?v=1666473458822') }}">
</head>
<body onload="onLoad()">
